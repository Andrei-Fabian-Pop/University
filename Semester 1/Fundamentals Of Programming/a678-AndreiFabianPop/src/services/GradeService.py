...
class GradeService:
    ...
    def add_grade(self, student_id, discipline_id, grade_value, history_service):
        """
        ...
        try:
            ...
            if self.__id_dump:
                grade = Grade(self.__id_dump[-1], discipline_id, student_id, grade_value)
                history_service.add_expression("add", "grade", [self.__id_dump[-1], discipline_id, student_id, grade_value])
                self.__id_dump.pop()
            else:
                grade = Grade(self.__id, discipline_id, student_id, grade_value)
                history_service.add_expression("add", "grade", [self.__id, discipline_id, student_id, grade_value])
                self.__id += 1
            if self.__validator.validate_grade(grade) or self.__test_flag:
    ...
    def delete_grade(self, grade_id):
        ...
        :return: None
        """
        self.__id_dump.append(grade_id)
